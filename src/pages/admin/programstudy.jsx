...
export default function ProgramList() {
    ...
    const fetchData = async () => {
        try {
            // const response = await axiosClient.get('http://192.168.18.176:5000/prodi/all');
    ...
    const fetchAkreditasi = async () => {
        try {
            // const response = await axiosClient.get('http://192.168.18.176:5000/prodi/akreditasi/all');
    ...
    const fetchJenjang = async () => {
        try {
            // const response = await axiosClient.get('http://192.168.18.176:5000/prodi/jenjang/all');
    ...
    const AddProgram = async () => {
        try {
            ...
            // const response = await axiosClient.post('http://192.168.18.176:5000/prodi/add', newProgram)
    ...
    const deleteProgram = async (programId) => {
        try {
            // const response = await axiosClient.delete(`http://192.168.18.176:5000/prodi/delete/${psdkuId}`)
    ...
    const handleEditSubmit = async (event) => {
        ...
        try {
            // const response = await axiosClient.put(`http://192.168.18.176:5000/prodi/edit/${editProgram._id}`, editProgram);
