            ...
            <div className="row mb-4">
                <div className="col">
                    <ul className="mt-3 gap-3 text-white nav nav-pills justify-content-center">
                        ...
                        <li className="nav-item">
                            <span className="active border rounded bg-primary bg-opacity-50 p-2">Golongan Kegiatan</span>
                        </li>
                        <li className="nav-item">
                ...
                <div className="mt-4">
                    ...
                    <table className="table">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <input type="checkbox" /> Politeknik LP3I
                                </td>
                                <td>
                                ...
                                <td>
                                    <div className="d-flex flex-column">
                                        ...
                                        <label><input type="checkbox" /> Hubungan Masyarakat</label>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    <input type="checkbox" /> Politeknik LP3I Kampus Tasikmalaya
                                </td>
                                <td>
                                    <div className="d-flex flex-column text-center">
                                        <label>D2</label>
                                ...
                                <td>
                                    <div className="d-flex flex-column">
                                        <label><input type="checkbox" /> Manajement Pemasaran</label>
                                        <label><input type="checkbox" /> Manajement Keuangan Perbangkan</label>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <input type="checkbox" /> Politeknik LP3I Kampus Pekanbaru
                                </td>
                                <td>
                                    <div className="d-flex flex-column text-center">
                                        <label>D2</label>
                                ...
                                <td>
                                    <div className="d-flex flex-column">
                                        <label><input type="checkbox" /> Administrasi Bisnis</label>
                                        <label><input type="checkbox" /> Manajemen Informatika</label>
                                        <label><input type="checkbox" /> Komputerisansi Akuntasi</label>
                                        <label><input type="checkbox" /> Hubungan Masyarakat</label>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <input type="checkbox" /> Politeknik LP3I Kampus Cirebon
                                </td>
                                <td>
                                    <div className="d-flex flex-column text-center">
                                        <label>D3</label>
                                ...
                                <td>
                                    <div className="d-flex flex-column">
                                        <label><input type="checkbox" /> Manajemen Informatika</label>
                                        <label><input type="checkbox" /> Teknik Komputer</label>
                                    </div>
                                </td>
                            </tr>
                            <tr>
