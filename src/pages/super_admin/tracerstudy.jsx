                    ...
                    <table className="table mt-4">
                        <thead className='table table-secondary'>
                            <tr>
                                ...
                                <th className="text-dark fw-semibold text-truncate">Nama Kegiatan</th>
                                <th className="text-dark fw-semibold text-truncate">Tanggal Mulai</th>
                                <th className="text-dark fw-semibold text-truncate">Tanggal Berakhir</th>
