    ...
    return (
        <div className="container mt-4" style={{ paddingLeft: '24px', paddingRight: '24px' }}>
            ...
            >
                ...
                <div className="mt-5 d-row d-md-flex justify-content-between">
                    <div>
                    ...
                    <div className='mt-md-0 mt-3 d-flex justify-content-end'>
                        <Link to="/super_admin/kampusedit">
                            <button className="ms-5 border rounded p-2 bg-success bg-opacity-75 text-light d-none d-sm-inline d-md-inline" type="button">Edit Informasi</button>
                        </Link>
                    </div>
